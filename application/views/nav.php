 <!-- Navigation -->
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.html">云报销</a>
            </div>
            <!-- /.navbar-header -->
            ...
            <ul class="nav navbar-top-links navbar-right">
                ...
                <li class="dropdown">
                    ...
                    <li><a href="<?php echo base_url('users/profile'); ?>"><i class="fa fa-user fa-fw"></i> 个人信息</a> </li>
                    <li><a href="<?php echo base_url('users/avatar'); ?>"><i class="fa fa-gear fa-fw"></i>头像管理 </a> </li>
                    <li><a href="<?php echo base_url('users/password'); ?>"><i class="fa fa-key fa-fw"></i>修改密码</a> </li>
                        <li class="divider"></li>
                        <li><a href="<?php echo base_url('users/logout'); ?>"><i class="fa fa-sign-out fa-fw"></i> 注销</a>
                        </li>
                    </ul>
                    <!-- /.dropdown-user -->
                </li>
            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            <a class="active node" href="<?php echo base_url('relations'); ?>"><i class="glyphicon glyphicon-tree-conifer"></i> 人员关系管理</a>
                        </li>
                        <li>
                            <a class="node" href="<?php echo base_url('category'); ?>"><i class="glyphicon glyphicon-floppy-open"></i>报销分类管理</a>
                        </li>
                        <li>
...
<?php
$avatar = base_url() . "res/img/default.avatar.png";
//if($profile['avatar']){
