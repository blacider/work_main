...
$(document).ready(function(){
    ...
    $('.chb').click(function(e){
        var _sch = $(this).attr('checked');
        var _s = $($(this).parents('tr').get(0)).hasClass('selected');
        if(_s){
            $($(this).parents('tr').get(0)).removeClass('selected');
        }else{
    ...
    $('#markdown').click(function(){
            ...
            $('.chb').each(function(){
                if($(this).attr('checked')){
                    var _id = $($(this).parents('tr').get(0)).data('id');
                    _ids.push(_id);
                }
            });
