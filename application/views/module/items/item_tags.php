...
<select class="form-control  chosen-select tag-input-style default_custom need_check" data-id="<?php echo $item_customization_value['id'];?>" id="item_tags" name="tags[]" multiple="multiple" data-placeholder="请选择标签">
