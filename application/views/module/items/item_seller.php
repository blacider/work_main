...
<input type="text" name="merchant" id="merchant" class="form-controller col-xs-12 default_custom need_check" data-id="<?php echo $item_customization_value['id'];?>" placeholder="消费商家">
</div>
</div>
