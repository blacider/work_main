...
(function () {
    ...
    var SCM_URL = localhostpath+projectname+'/' ;
    /**
    ...
    window.UEDITOR_CONFIG = {
        ...
        //,savePath: [ URL+'php/img' ]    //图片保存在服务器端的目录， 默认为空， 此时在上传图片时会向服务器请求保存图片的目录列表，
        ...
        ,filePath:SCM_URL + "../"                   //附件修正地址，同imagePath
        ...
        ,videoPath:SCM_URL                   //附件修正地址，同imagePath
