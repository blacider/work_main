...
jQuery(grid_selector).jqGrid({
    ...
    multiselect: true,
    loadtext: '',
    colNames:['报销单ID', '报销单模板', '提交日期','报销单名', '消费类型' ,'条目数', '提交者', '金额', '状态', '审批日期', '操作','部门'], 
    loadonce: true,
    caption: "费用审计",
    ...
    {name:'status_str',index:'status_str', width:50, editable: true,edittype:"select",editoptions: {value:"4:通过;3:拒绝"},unformat: aceSwitch,search:false},
