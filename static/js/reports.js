...
try{
    jQuery(grid_selector).jqGrid({
        ...
        datatype: "local",
        height: 250,
        colNames:['ID', '报告模板', '标题', '消费类型',  '创建日期', '金额','消费条目数', '附件', '状态', '操作'],
        loadonce: true,
        caption: "报告列表",
        ...
        {name:'attachments',index:'attachments', width:40, editable: false,editoptions: {size:"20", maxlength : "30"},search:false},
